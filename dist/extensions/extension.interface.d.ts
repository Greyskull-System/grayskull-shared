 ...
 */
export type ExtensionHook = 'employee.beforeCreate' | 'employee.afterCreate' | 'employee.beforeUpdate' | 'employee.afterUpdate' | 'employee.beforeDelete' | 'vacation.beforeCalculate' | 'vacation.afterCalculate' | 'vacation.beforeApprove' | 'vacation.afterApprove' | 'payroll.beforeGenerate' | 'payroll.afterGenerate' | 'payroll.beforeClose' | 'payroll.afterClose';
